...
import { Category, Vocabulary, User, Progress, Session, query, get, all, run } from './database/db-connector'
...
const vocabulary: Record<string, Word[]> = {
  greetings: [
    { id: 1, turkish: "Merhaba", arabic: "??????????", english: "Hello", pronunciation: "mer-ha-BA", 
      example: "Merhaba, nas??ls??n??z?", exampleArabic: "???????????? ?????? ??????????",
      icon: "fas fa-hand-wave", emoji: "????" },
    { id: 2, turkish: "G??nayd??n", arabic: "???????? ??????????", english: "Good morning", pronunciation: "g??n-ay-DIN",
      example: "G??nayd??n! Bug??n hava ??ok g??zel.", exampleArabic: "???????? ??????????! ?????????? ???????? ???????? ??????????.",
      icon: "fas fa-sun", emoji: "??????" },
    { id: 3, turkish: "??yi ak??amlar", arabic: "???????? ??????????", english: "Good evening", pronunciation: "i-yi ak-sham-LAR",
      example: "??yi ak??amlar, iyi dinlenmeler.", exampleArabic: "???????? ???????????? ?????????????? ????????.",
      icon: "fas fa-moon", emoji: "????" },
    { id: 4, turkish: "Ho????a kal??n", arabic: "??????????", english: "Goodbye", pronunciation: "hosh-CHA ka-LIN",
      example: "Ho????a kal??n, yar??n g??r??????r??z.", exampleArabic: "?????????????? ?????????? ????????.",
      icon: "fas fa-hand-paper", emoji: "????" },
    { id: 5, turkish: "L??tfen", arabic: "???? ????????", english: "Please", pronunciation: "l??t-FEN",
      example: "L??tfen bana yard??m edin.", exampleArabic: "???? ???????? ????????????.",
      icon: "fas fa-hands-praying", emoji: "????" },
    { id: 6, turkish: "Te??ekk??r ederim", arabic: "???????? ????", english: "Thank you", pronunciation: "te-shek-K??R e-de-RIM",
      example: "Yard??m??n??z i??in te??ekk??r ederim.", exampleArabic: "?????????? ???? ?????? ??????????????.",
      icon: "fas fa-heart", emoji: "??????" }
  ],
  travel: [
    { id: 7, turkish: "Havaalan??", arabic: "????????????", english: "Airport", pronunciation: "ha-va-a-la-NI",
      example: "Havaalan??na taksiyle gittim.", exampleArabic: "???????? ?????? ???????????? ????????????????.",
      icon: "fas fa-plane", emoji: "??????" },
    { id: 8, turkish: "Otel", arabic: "????????", english: "Hotel", pronunciation: "o-TEL",
      example: "Bu otel ??ok g??zel.", exampleArabic: "?????? ???????????? ???????? ????????.",
      icon: "fas fa-bed", emoji: "????" },
    { id: 9, turkish: "Taksi", arabic: "??????????", english: "Taxi", pronunciation: "tak-SI",
      example: "Taksi ??a????rabilir misiniz?", exampleArabic: "???? ?????????? ?????????????? ????????????",
      icon: "fas fa-taxi", emoji: "????" },
    { id: 10, turkish: "Otobus", arabic: "??????????", english: "Bus", pronunciation: "o-to-B??S",
      example: "Otobus dura???? nerede?", exampleArabic: "?????? ???????? ????????????????",
      icon: "fas fa-bus", emoji: "????" },
    { id: 11, turkish: "Tren", arabic: "????????", english: "Train", pronunciation: "TREN",
      example: "Tren saat ka??ta kalk??yor?", exampleArabic: "?????? ?????????? ??????????????",
      icon: "fas fa-train", emoji: "????" },
    { id: 12, turkish: "Bilet", arabic: "??????????", english: "Ticket", pronunciation: "bi-LET",
      example: "Bir bilet istiyorum.", exampleArabic: "???????? ?????????? ??????????.",
      icon: "fas fa-ticket-alt", emoji: "????" }
  ],
  food: [
    { id: 13, turkish: "Su", arabic: "??????", english: "Water", pronunciation: "SU",
      example: "Bir bardak su istiyorum.", exampleArabic: "???????? ?????? ???? ??????????.",
      icon: "fas fa-tint", emoji: "????" },
    { id: 14, turkish: "Ekmek", arabic: "??????", english: "Bread", pronunciation: "ek-MEK",
      example: "Ekmek ??ok taze.", exampleArabic: "?????????? ???????? ????????.",
      icon: "fas fa-bread-slice", emoji: "????" },
    { id: 15, turkish: "Et", arabic: "??????", english: "Meat", pronunciation: "ET",
      example: "Et yemek istemiyorum.", exampleArabic: "???? ???????? ???? ?????? ??????????.",
      icon: "fas fa-drumstick-bite", emoji: "????" },
    { id: 16, turkish: "Bal??k", arabic: "??????", english: "Fish", pronunciation: "ba-LIK",
      example: "Bal??k ??ok lezzetli.", exampleArabic: "?????????? ???????? ????????.",
      icon: "fas fa-fish", emoji: "????" },
    { id: 17, turkish: "Sebze", arabic: "????????", english: "Vegetable", pronunciation: "seb-ZE",
      example: "Taze sebze seviyorum.", exampleArabic: "?????? ???????????? ??????????????.",
      icon: "fas fa-carrot", emoji: "????" },
    { id: 18, turkish: "Meyve", arabic: "??????????", english: "Fruit", pronunciation: "mey-VE",
      example: "Meyve ??ok sa??l??kl??.", exampleArabic: "?????????????? ???????? ????????.",
      icon: "fas fa-apple-alt", emoji: "????" }
  ],
  shopping: [
    { id: 19, turkish: "Ne kadar?", arabic: "???? ????????????", english: "How much?", pronunciation: "ne ka-DAR",
      example: "Bu ne kadar?", exampleArabic: "???? ?????? ????????",
      icon: "fas fa-question-circle", emoji: "???" },
    { id: 20, turkish: "??ok pahal??", arabic: "???????? ??????", english: "Too expensive", pronunciation: "chok pa-ha-LI",
      example: "Bu ??ok pahal??, daha ucuzu var m???", exampleArabic: "?????? ???????? ?????????? ???? ???????? ??????????",
      icon: "fas fa-exclamation-triangle", emoji: "????" },
    { id: 21, turkish: "Ucuz", arabic: "????????", english: "Cheap", pronunciation: "u-JUZ",
      example: "Bu ??ok ucuz bir fiyat.", exampleArabic: "?????? ?????? ???????? ????????.",
      icon: "fas fa-tag", emoji: "???????" },
    { id: 22, turkish: "Para", arabic: "??????", english: "Money", pronunciation: "pa-RA",
      example: "Yeterli param yok.", exampleArabic: "?????? ?????? ?????? ????????.",
      icon: "fas fa-coins", emoji: "????" },
    { id: 23, turkish: "Sat??n almak", arabic: "????????", english: "To buy", pronunciation: "sa-tin al-MAK",
      example: "Bunu sat??n almak istiyorum.", exampleArabic: "???????? ???????? ??????.",
      icon: "fas fa-shopping-cart", emoji: "????" },
    { id: 24, turkish: "Ma??aza", arabic: "????????", english: "Store", pronunciation: "ma-a-za",
      example: "En yak??n ma??aza nerede?", exampleArabic: "?????? ???????? ??????????",
      icon: "fas fa-store", emoji: "????" }
  ],
  directions: [
    { id: 25, turkish: "Nerede?", arabic: "????????", english: "Where?", pronunciation: "ne-re-DE",
      example: "Tuvalet nerede?", exampleArabic: "?????? ???????? ??????????????",
      icon: "fas fa-map-marker-alt", emoji: "????" },
    { id: 26, turkish: "Sa??", arabic: "????????", english: "Right", pronunciation: "SA",
      example: "Sa??a d??n??n.", exampleArabic: "?????????????? ????????????.",
      icon: "fas fa-arrow-right", emoji: "??????" },
    { id: 27, turkish: "Sol", arabic: "????????", english: "Left", pronunciation: "SOL",
      example: "Sola git.", exampleArabic: "???????? ????????????.",
      icon: "fas fa-arrow-left", emoji: "??????" },
    { id: 28, turkish: "??leri", arabic: "?????? ????????????", english: "Forward", pronunciation: "i-le-RI",
      example: "D??z ileri gidin.", exampleArabic: "???????????? ???????????? ?????? ????????????.",
      icon: "fas fa-arrow-up", emoji: "??????" },
    { id: 29, turkish: "Geri", arabic: "?????? ????????????", english: "Back", pronunciation: "ge-RI",
      example: "Geri d??nelim.", exampleArabic: "?????????? ???????? ?????? ????????????.",
      icon: "fas fa-arrow-down", emoji: "??????" },
    { id: 30, turkish: "Yak??n", arabic: "????????", english: "Close", pronunciation: "ya-KIN",
      example: "Buras?? ??ok yak??n.", exampleArabic: "?????? ???????????? ???????? ????????.",
      icon: "fas fa-map-pin", emoji: "????" }
  ],
  emergency: [
    { id: 31, turkish: "Yard??m!", arabic: "????????????!", english: "Help!", pronunciation: "yar-DIM",
      example: "Yard??m edin! Kayboldum.", exampleArabic: "??????????????! ?????? ??????.",
      icon: "fas fa-exclamation-triangle", emoji: "????" },
    { id: 32, turkish: "Polis", arabic: "????????", english: "Police", pronunciation: "po-LIS",
      example: "Polisi ??a????r??n.", exampleArabic: "???????????? ??????????????.",
      icon: "fas fa-shield-alt", emoji: "????" },
    { id: 33, turkish: "Doktor", arabic: "????????", english: "Doctor", pronunciation: "dok-TOR",
      example: "Doktora ihtiyac??m var.", exampleArabic: "?????????? ?????? ????????.",
      icon: "fas fa-user-md", emoji: "?????????????" },
    { id: 34, turkish: "Hastane", arabic: "????????????", english: "Hospital", pronunciation: "has-ta-NE",
      example: "En yak??n hastane nerede?", exampleArabic: "?????? ???????? ??????????????",
      icon: "fas fa-hospital", emoji: "????" },
    { id: 35, turkish: "Acil", arabic: "??????????", english: "Emergency", pronunciation: "a-JIL",
      example: "Bu acil durum!", exampleArabic: "?????? ???????? ??????????!",
      icon: "fas fa-ambulance", emoji: "????" },
    { id: 36, turkish: "Hasta", arabic: "????????", english: "Sick", pronunciation: "has-TA",
      example: "??ok hastay??m.", exampleArabic: "?????? ???????? ????????.",
      icon: "fas fa-thermometer-half", emoji: "????" }
  ],
  time: [
    { id: 37, turkish: "Saat", arabic: "????????", english: "Hour/Clock", pronunciation: "sa-AT",
      example: "Saat ka???", exampleArabic: "???? ??????????????",
      icon: "fas fa-clock", emoji: "????" },
    { id: 38, turkish: "G??n", arabic: "??????", english: "Day", pronunciation: "G??N",
      example: "G??zel bir g??n.", exampleArabic: "?????? ????????.",
      icon: "fas fa-calendar-day", emoji: "????" },
    { id: 39, turkish: "Hafta", arabic: "??????????", english: "Week", pronunciation: "haf-TA",
      example: "Gelecek hafta d??nece??im.", exampleArabic: "?????????? ?????????????? ????????????.",
      icon: "fas fa-calendar-week", emoji: "????" },
    { id: 40, turkish: "Ay", arabic: "??????", english: "Month", pronunciation: "AY",
      example: "Bu ay ??ok me??gul??m.", exampleArabic: "?????? ?????????? ???????? ?????? ??????????.",
      icon: "fas fa-calendar-alt", emoji: "???????" },
    { id: 41, turkish: "Y??l", arabic: "??????", english: "Year", pronunciation: "YIL",
      example: "Bu y??l T??rkiye'ye gidece??im.", exampleArabic: "?????????? ?????? ?????????? ?????? ??????????.",
      icon: "fas fa-calendar", emoji: "????" },
    { id: 42, turkish: "Bug??n", arabic: "??????????", english: "Today", pronunciation: "bu-G??N",
      example: "Bug??n ??ok yorgunum.", exampleArabic: "?????? ???????? ???????? ??????????.",
      icon: "fas fa-calendar-check", emoji: "????" }
  ],
  numbers: [
    { id: 43, turkish: "Bir", arabic: "????????", english: "One", pronunciation: "BIR",
      example: "Bir ??ay l??tfen.", exampleArabic: "?????? ???????? ???? ????????.",
      icon: "fas fa-dice-one", emoji: "1??????" },
    { id: 44, turkish: "??ki", arabic: "??????????", english: "Two", pronunciation: "i-KI",
      example: "??ki bilet istiyorum.", exampleArabic: "???????? ??????????????.",
      icon: "fas fa-dice-two", emoji: "2??????" },
    { id: 45, turkish: "????", arabic: "??????????", english: "Three", pronunciation: "??CH",
      example: "???? g??n kalaca????m.", exampleArabic: "?????????? ???????????? ????????.",
      icon: "fas fa-dice-three", emoji: "3??????" },
    { id: 46, turkish: "D??rt", arabic: "??????????", english: "Four", pronunciation: "D??RT",
      example: "D??rt ki??iyiz.", exampleArabic: "?????? ?????????? ??????????.",
      icon: "fas fa-dice-four", emoji: "4??????" },
    { id: 47, turkish: "Be??", arabic: "????????", english: "Five", pronunciation: "BESH",
      example: "Be?? dakika bekleyin.", exampleArabic: "?????????????? ?????? ??????????.",
      icon: "fas fa-dice-five", emoji: "5??????" },
    { id: 48, turkish: "On", arabic: "????????", english: "Ten", pronunciation: "ON",
      example: "On lira ??dedim.", exampleArabic: "???????? ?????? ??????????.",
...
app.get('/api/categories', (c) => {
  ...
  const enhancedCategories = [
    { id: 'adjective', name: 'Adjective', nameArabic: '????????????', wordCount: "77", sessionCount: 8, icon: '????' },
    { id: 'animal', name: 'Animal', nameArabic: '??????????????????', wordCount: "54", sessionCount: 6, icon: '????' },
    { id: 'body', name: 'Body', nameArabic: '?????????? ??????????', wordCount: "78", sessionCount: 8, icon: '????' },
    { id: 'clothes', name: 'Clothes', nameArabic: '??????????????', wordCount: "20", sessionCount: 2, icon: '????' },
    { id: 'color', name: 'Color', nameArabic: '??????????????', wordCount: "18", sessionCount: 2, icon: '????' },
    { id: 'direction', name: 'Direction', nameArabic: '??????????????????', wordCount: "3", sessionCount: 1, icon: '????' },
    { id: 'emotion', name: 'Emotion', nameArabic: '??????????????', wordCount: "14", sessionCount: 2, icon: '????' },
    { id: 'family', name: 'Family', nameArabic: '??????????????', wordCount: "73", sessionCount: 8, icon: '?????????????????????????' },
    { id: 'finance', name: 'Finance', nameArabic: '??????????????', wordCount: "22", sessionCount: 3, icon: '????' },
    { id: 'food', name: 'Food', nameArabic: '????????????', wordCount: "113", sessionCount: 12, icon: '???????' },
    { id: 'general', name: 'General', nameArabic: '??????', wordCount: "9", sessionCount: 1, icon: '????' },
    { id: 'health', name: 'Health', nameArabic: '??????????', wordCount: "38", sessionCount: 4, icon: '????' },
    { id: 'house', name: 'House', nameArabic: '????????????', wordCount: "76", sessionCount: 8, icon: '????' },
    { id: 'instrument', name: 'Instrument', nameArabic: '????????????', wordCount: "7", sessionCount: 1, icon: '????' },
    { id: 'measurement', name: 'Measurement', nameArabic: '????????????', wordCount: "24", sessionCount: 3, icon: '????' },
    { id: 'music', name: 'Music', nameArabic: '????????????????', wordCount: "12", sessionCount: 2, icon: '????' },
    { id: 'nature', name: 'Nature', nameArabic: '??????????????', wordCount: "37", sessionCount: 4, icon: '????' },
    { id: 'number', name: 'Number', nameArabic: '??????????????', wordCount: "20", sessionCount: 2, icon: '????' },
    { id: 'place', name: 'Place', nameArabic: '??????????????', wordCount: "37", sessionCount: 4, icon: '????' },
    { id: 'plant', name: 'Plant', nameArabic: '????????????????', wordCount: "6", sessionCount: 1, icon: '????' },
    { id: 'pronoun', name: 'Pronoun', nameArabic: '??????????????', wordCount: "3", sessionCount: 1, icon: '????' },
    { id: 'religion', name: 'Religion', nameArabic: '??????????', wordCount: "5", sessionCount: 1, icon: '????' },
    { id: 'school', name: 'School', nameArabic: '??????????????', wordCount: "55", sessionCount: 6, icon: '????' },
    { id: 'science', name: 'Science', nameArabic: '????????????', wordCount: "66", sessionCount: 7, icon: '????' },
    { id: 'sport', name: 'Sport', nameArabic: '??????????????', wordCount: "16", sessionCount: 2, icon: '???' },
    { id: 'technology', name: 'Technology', nameArabic: '??????????????????????', wordCount: "36", sessionCount: 4, icon: '????' },
    { id: 'time', name: 'Time', nameArabic: '??????????', wordCount: "54", sessionCount: 6, icon: '???' },
    { id: 'travel', name: 'Travel', nameArabic: '??????????', wordCount: "46", sessionCount: 5, icon: '??????' },
    { id: 'verb', name: 'Verb', nameArabic: '??????????????', wordCount: "43", sessionCount: 5, icon: '????' },
    { id: 'weather', name: 'Weather', nameArabic: '??????????', wordCount: "13", sessionCount: 2, icon: '???????' },
    { id: 'work', name: 'Work', nameArabic: '??????????', wordCount: "51", sessionCount: 6, icon: '????' }
  ];
...
// ??????? DATABASE-ENABLED API ENDPOINTS
...
app.get('/api/db/user/progress', async (c) => {
  try {
    ...
    const userId = 1; // Default test user (number)
...
app.post('/api/db/vocabulary/progress', async (c) => {
  try {
    ...
    // Convert vocabularyId to number if it's a string
    const vocabIdNum = typeof vocabularyId === 'string' ? parseInt(vocabularyId) : vocabularyId;
    
    // Validate the conversion
    if (isNaN(vocabIdNum)) {
      return c.json({ success: false, message: 'Invalid vocabulary ID' }, 400);
    }
    
    await Progress.updateVocabularyProgress(userId, vocabIdNum, progress);
...
app.post('/api/auth/login', async (c) => {
  try {
    ...
    if (!user) {
      console.warn('?????? Login attempted for non-existent user:', email);
...
app.get('/api/phrases/:category', (c) => {
  ...
  const phrases: Record<string, any> = {
    daily: {
      ...
      phrases: [
        {
          id: 1, turkish: "Nas??l gidiyor?", arabic: "?????? ???????? ??????????????", 
          english: "How's it going?", pronunciation: "na-s??l gi-di-yor",
          usage: "Casual greeting between friends",
          culturalNote: "More casual than 'Nas??ls??n??z?' - shows familiarity",
          examples: [
            { sentence: "Selam! Nas??l gidiyor i??ler?", arabic: "????????????! ?????? ???????? ????????????????" },
            { sentence: "Nas??l gidiyor okul?", arabic: "?????? ???????? ????????????????" }
          ]
        },
        {
          id: 2, turkish: "??ok g??zel!", arabic: "???????? ????????!", 
          english: "Very beautiful/nice!", pronunciation: "chok g??-zel",
          usage: "Expressing admiration or approval",
          culturalNote: "Universal positive expression, very commonly used",
          examples: [
            { sentence: "Bu manzara ??ok g??zel!", arabic: "?????? ???????????? ???????? ????????!" },
            { sentence: "Yeme??in ??ok g??zel!", arabic: "???????????? ???????? ????????!" }
          ]
        }
      ]
    },
    restaurant: {
      ...
      phrases: [
        {
          id: 10, turkish: "Hesap, l??tfen", arabic: "?????????????? ???? ????????", 
          english: "The bill, please", pronunciation: "he-sap l??t-fen",
          usage: "Requesting the check at restaurants",
          culturalNote: "Polite way to ask for bill. Tipping 10-15% is customary",
          examples: [
            { sentence: "Afedersiniz, hesap l??tfen.", arabic: "???????????? ???????????? ???? ????????." },
            { sentence: "Hesab?? ay??rabilir misiniz?", arabic: "???? ???????????? ?????????? ??????????????" }
          ]
        }
      ]
    }
...
app.get('/api/phrases', (c) => {
  const categories = [
    { id: 'daily', name: 'Daily Phrases', nameArabic: '???????????????? ??????????????', difficulty: 'beginner', count: 2 },
    { id: 'restaurant', name: 'Restaurant Phrases', nameArabic: '???????????? ????????????', difficulty: 'intermediate', count: 1 },
    { id: 'shopping', name: 'Shopping Phrases', nameArabic: '???????????? ????????????', difficulty: 'intermediate', count: 1 },
    { id: 'advanced', name: 'Advanced Expressions', nameArabic: '?????????????????? ????????????????', difficulty: 'advanced', count: 1 }
  ];
    ...
    hotel: {
      ...
      dialogue: [
        ...
        },
        {
          ...
          turkish: "Tabii efendim, ad??n??z nedir?",
          arabic: "???????????? ?????????? ???? ??????????",
          english: "Of course sir, what is your name?",
          pronunciation: "ta-BII e-fen-DIM, a-d??-N??Z ne-DIR"
        },
        {
          speaker: "Guest",
          turkish: "Benim ad??m Ahmed Hassan.",
          arabic: "???????? ???????? ??????.",
          english: "My name is Ahmed Hassan.",
          pronunciation: "be-NIM a-D??M ah-MED has-SAN"
        }
      ],
      keyPhrases: [
        { turkish: "Rezervasyonum var", arabic: "?????? ??????", english: "I have a reservation" },
        { turkish: "Ad??n??z nedir?", arabic: "???? ??????????", english: "What is your name?" },
        { turkish: "Oda anahtar??", arabic: "?????????? ????????????", english: "Room key" }
      ]
    },
    restaurant: {
      title: "Ordering Food",
      ...
      dialogue: [
        {
          speaker: "Waiter",
          turkish: "Ho?? geldiniz! Ne istiyorsunuz?",
          arabic: "?????????? ????????????! ???????? ??????????????",
        ...
        {
          speaker: "Customer",
          turkish: "Men??y?? g??rebilir miyim?",
          arabic: "???? ???????????? ???????? ????????????????",
          english: "Can I see the menu?",
          pronunciation: "me-N??-y?? g??-re-bi-LIR mi-YIM"
        }
      ]
    },
    taxi: {
      ...
      dialogue: [
        {
          speaker: "Passenger",
          turkish: "Havaalan??na gitmek istiyorum.",
          arabic: "???????? ???????????? ?????? ????????????.",
          english: "I want to go to the airport.",
          pronunciation: "ha-va-a-la-N??-NA git-MEK is-ti-yo-RUM"
        },
        {
          speaker: "Driver",
          turkish: "Tabii, ne kadar s??rer?",
          arabic: "?????????????? ???? ??????????????",
          english: "Sure, how long does it take?",
          pronunciation: "ta-BII, ne ka-DAR s??-RER"
        }
      ]
    }
  };
...
app.get('/api/admin/users/:id', requireAdmin, async (c) => {
  try {
    const userId = parseInt(c.req.param('id')); // Convert string to number
...
app.get('/api/admin/vocabulary', requireAdmin, async (c) => {
  try {
    const page = parseInt(c.req.query('page') || '1');
    // Use a reasonable default limit for pagination
    ...
    // Get difficulty levels for filter dropdown
...
app.get('/api/admin/vocabulary/:id', requireAdmin, async (c) => {
  try {
    const vocabId = parseInt(c.req.param('id')); // Convert string to number
    
    // Validate that vocabId is a valid number
    if (isNaN(vocabId)) {
      return c.json({ success: false, message: 'Invalid vocabulary ID' }, 400);
    }
...
app.put('/api/admin/vocabulary/:id', requireAdmin, async (c) => {
  try {
    ...
    // Add new fields to allowed updates
    const fields = [
      'category_id', 'turkish_text', 'english_text', 'arabic_text', 'turkish_pronunciation',
      'english_definition', 'word_type', 'difficulty_level', 'example_sentence_tr',
      'example_sentence_en', 'example_sentence_ar', 'audio_url', 'image_url', 'svg_icon',
    ...
    for (const field of fields) {
      if (field in allowedUpdates) {
        filteredUpdates[field] = allowedUpdates[field];
      }
    }
    ...
    const values = [...Object.values(filteredUpdates), vocabId];
    
    const result = await query(
      `UPDATE vocabulary SET ${setClause}, updated_at = datetime('now') 
...
app.get('/api/admin/categories', requireAdmin, async (c) => {
  try {
    ...
    const categoriesWithCount = await Promise.all(categories.map(async (category: any) => {
      ...
      return {
        ...category,
        word_count: parseInt(countResult[0].count)
      };
    }));
...
app.get('/api/admin/categories/:id', requireAdmin, async (c) => {
  try {
    const categoryId = parseInt(c.req.param('id')); // Convert string to number
...
app.post('/api/admin/vocabulary/upload', requireAdmin, async (c) => {
  try {
    ...
    return c.json({ success: false, message: 'Failed to upload vocabulary', error: (error as Error).message }, 500);
  }
});
...
app.get('/api/conversations', (c) => {
  const types = [
    { id: 'hotel', name: 'Hotel Check-in', nameArabic: '?????????? ???????????? ???? ????????????', difficulty: 'intermediate' },
    { id: 'restaurant', name: 'Ordering Food', nameArabic: '?????? ????????????', difficulty: 'beginner' },
    { id: 'taxi', name: 'Taking a Taxi', nameArabic: '???????? ??????????????', difficulty: 'beginner' },
    { id: 'shopping', name: 'Shopping', nameArabic: '????????????', difficulty: 'intermediate' },
    { id: 'directions', name: 'Asking for Directions', nameArabic: '???????????? ???? ??????????????????', difficulty: 'intermediate' }
  ];
  ...
  const tips = [
    {
      ...
      turkish: "T??rk??ede '??' harfi sessizdir ve ??ncesindeki sesliyi uzat??r.",
      arabic: "???? ???????????????? ?????? '??' ???????? ?????????? ?????????? ?????????????? ???????? ??????????.",
      english: "In Turkish, the letter '??' is silent and lengthens the preceding vowel.",
      example: "da?? (mountain) - pronounced like 'da:'"
    },
    {
      id: 2,
      category: "grammar",
      turkish: "T??rk??ede fiiller c??mlenin sonunda gelir.",
      arabic: "???? ???????????????? ?????????????? ???????? ???? ?????????? ????????????.",
    ...
    },
    {
      id: 3,
      category: "culture",
      turkish: "T??rkiye'de ??ay k??lt??r?? ??ok ??nemlidir. Misafirlere her zaman ??ay ikram edilir.",
      arabic: "???? ???????????? ?????????? ?????????? ???????? ????????. ?????????? ?????????? ???????????? ????????????.",
      english: "In Turkey, tea culture is very important. Tea is always offered to guests.",
      example: "??ay i??er misiniz? (Would you like some tea?)"
    },
    {
      id: 4,
      category: "vocabulary",
      turkish: "Bir??ok T??rk??e kelime Arap??a k??kenlidir.",
      arabic: "???????????? ???? ?????????????? ?????????????? ?????? ???????? ??????????.",
      english: "Many Turkish words have Arabic origins.",
      example: "kitap (book) from Arabic 'kit??b'"
    }
  ];
...
app.get('/api/enhanced-word/:id', (c) => {
  ...
  const enhancedWords: Record<number, any> = {
    1: {
      id: 1, turkish: "Merhaba", arabic: "??????????", english: "Hello", 
      pronunciation: "mer-ha-BA", difficulty: "beginner",
      examples: [
        { sentence: "Merhaba, nas??ls??n??z?", arabic: "???????????? ?????? ??????????", context: "formal" },
        { sentence: "Merhaba arkada??lar!", arabic: "?????????? ???????? ????????????????!", context: "informal" },
        { sentence: "Merhaba, benim ad??m Ali.", arabic: "???????????? ???????? ??????.", context: "introduction" }
      ],
      ...
      regionalVariations: [
        ...
        { region: "Izmir", variant: "Merhaba can??m", usage: "Warmer, friendly" }
      ],
      icon: "fas fa-hand-wave", emoji: "????"
    }
  };
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                setTimeout(function() {
                    if (window.FlashcardMode && window.FlashcardMode.prototype) {
                        ...
                        console.log('?????? FlashcardMode not found, retrying...');
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ...
                        if (window.gamificationSystem) {
                            ...
                            console.log('?????? Gamification system not available yet');
                        }
                    }, 2000);
                ...
                //     } else {
                //         console.log('?????? Retry flashcard override in 2s...');
                ...
                document.addEventListener('click', function(e) {
                    ...
                    if (target && (target.dataset.section === 'profile' || target.textContent.includes('?????????? ????????????'))) {
                    ...
                    window.loadStatsFromDatabase = async function() {
                        try {
                            ...
                            if (data.success && data.stats) {
                                ...
                                console.warn('?????? Failed to load database stats, using defaults');
                            }
                        } catch (error) {
                    ...
                    window.saveStatsToDatabase = async function(newStats) {
                        try {
                            ...
                            if (data.success) {
                                ...
                                console.warn('?????? Failed to save stats to database');
                                return false;
                            }
                        } catch (error) {
                    ...
                    window.updateAllStats = function(newStats) {
                        if (newStats) {
                            ...
                            window.saveStatsToDatabase(stats).catch(err => {
                                console.warn('?????? Failed to save stats to database:', err);
                    ...
                    window.startNewFlashcardSession = async function(options = {}) {
                        ...
                        if (window.enhancedVocabularyData) {
                            ...
                            setTimeout(() => {
                                ...
                                if (window.enhancedVocabularyData) {
                                    console.log('  ?????? TIMING ISSUE DETECTED: Data loaded after function call');
                                }
                            }, 1000);
                        }
                        console.log('================================================');
                        ...
                        try {
                            ...
                            if (window.showSection) {
                                ...
                                setTimeout(() => {
                                    ...
                                    console.log('?????? Manual selection needed - choose a category');
                                }, 1500);
                            }
            ...
            <section id="dashboard-section" class="content-section active">
                ...
                <div class="hero-section">
                    <div class="hero-background">
                        <div class="floating-words">
                            <span class="floating-word" style="--delay: 0s;">??????????</span>
                            <span class="floating-word" style="--delay: 0.5s;">Merhaba</span>
                            <span class="floating-word" style="--delay: 1s;">????????????</span>
                            <span class="floating-word" style="--delay: 1.5s;">Te??ekk??rler</span>
                            <span class="floating-word" style="--delay: 2s;">????????</span>
                            <span class="floating-word" style="--delay: 2.5s;">Ho????a kal</span>
                        </div>
                    </div>
                ...
                <div id="features-section" class="features-showcase">
                    <div class="section-header-modern">
                        <h2 class="section-title-large">?????????? ?????????? ??????????????</h2>
                        <p class="section-subtitle-large">???????????? ???????????? ?????????????? ?????????? ???????????? ???????? ??????????????????</p>
                    </div>
                    ...
                    <div class="features-grid">
                        ...
                        <div class="feature-card secondary">
                            ...
                            <h3 class="feature-title">?????? ?????????? ????????</h3>
                            <p class="feature-description">?????????? ???????? ?????????? ???? ?????????????? ???????????? ???? ?????????? TTS ????????????????</p>
                ...
                <div class="quick-start-section">
                    <div class="quick-start-header">
                        <h2 class="quick-start-title">???????? ???? ?????????? ????????????</h2>
                        <p class="quick-start-subtitle">???????? ?????????????? ???????? ???????????? ?????????? ???????? ????????????</p>
                    </div>
                    
                    <div class="learning-paths">
                        <div class="learning-path beginner">
                            <div class="path-header">
                                <span class="path-level">??????????</span>
                                <span class="path-icon">????</span>
                            </div>
                            <h3 class="path-title">???????? ???? ??????????</h3>
                            <p class="path-description">???????? ?????????????????? ???????????????? ???????????? ??????????????????</p>
                            <div class="path-features">
                                <span class="path-feature">??? 500 ???????? ????????????</span>
                                <span class="path-feature">??? ?????????? ????????????</span>
                                <span class="path-feature">??? ?????????????? ??????????????????</span>
                            </div>
                        ...
                        <div class="learning-path intermediate highlighted">
                            ...
                            <p class="path-description">?????? ?????????????? ?????????? ??????????????????</p>
                            <div class="path-features">
                                <span class="path-feature">??? 1000+ ????????</span>
                                <span class="path-feature">??? ?????????????? ????????????</span>
                                <span class="path-feature">??? ?????????? ????????????</span>
                            </div>
                        ...
                        <div class="learning-path advanced">
                            ...
                            <p class="path-description">?????????????? ???????????? ???????????????? ??????????</p>
                            <div class="path-features">
                                <span class="path-feature">??? 2000+ ????????</span>
                                <span class="path-feature">??? ?????????????? ????????????????</span>
                                <span class="path-feature">??? ?????????????? ????????????</span>
                            </div>
                ...
                <div class="learning-main-layout">
                    ...
                    <div class="learning-settings-column">
                        ...
                        <div class="enhanced-controls-notice" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 1.5rem; border-radius: 1rem; text-align: center;">
                            ...
                            <p style="margin: 0 0 1rem 0; opacity: 0.9;">???????????? ?????????????? ???????????????? ?????????????? ???????????? ???????? ???????????? ???????? ??????????</p>
            ...
            <section id="review-section" class="content-section">
                ...
                <div id="review-interface">
                    ...
                    <div class="review-controls">
                        <button id="start-review" class="btn-primary">???????? ????????????????</button>
                        <button id="review-all" class="btn-secondary">???????? ????????</button>
                    </div>
            ...
            <section id="conversation-section" class="content-section">
                <div class="section-header">
                    ...
                    <div class="daily-tip-card" id="daily-tip-card">
                        <div class="daily-tip-header">
                            ...
                            <span class="daily-tip-title">?????????? ??????????</span>
                ...
                <div id="conversation-interface">
                    ...
                    <div class="conversation-selection">
                        <h3 class="conversation-selection-title">???????? ???????? ????????????????</h3>
                ...
                <div class="profile-dashboard">
                    ...
                    <div class="progress-overview">
                        <div class="progress-card">
                            <h3 class="progress-card-title">???????????? ????????????</h3>
                    ...
                    <div class="gamification-section">
                        <h3 class="gamification-title">???? ???????? ???????????????? ??????????????????</h3>
                        ...
                        <div class="challenges-container">
                            <div class="challenges-card">
                                <h4 class="challenges-card-title">
                                    ...
                                    ???????????????? ??????????????
                                    <span class="streak-multiplier" id="streak-multiplier" style="display: none;">2x ????????!</span>
                                </h4>
                                ...
                                <div class="weekly-leaderboard" id="weekly-leaderboard">
                                    <div class="leaderboard-item self">
                                        ...
                                        <div class="player-info">
                                            ...
                                            <div class="player-score"><span id="user-weekly-score">0</span> ????????</div>
                                        </div>
                        ...
                        <div class="achievement-chains">
                            <h4 class="achievement-chains-title">?????????? ??????????????????</h4>
                        ...
                        <div class="achievements-section">
                            <h4 class="achievements-title">?????????????????? ????????????????</h4>
                            <div class="achievements-grid" id="achievements-grid">
                                ...
                                <div class="achievement-badge locked" data-achievement="streak-7">
                                    <div class="badge-icon">????</div>
                                    <div class="badge-name">?????????? ????????</div>
                                    <div class="badge-description">7 ???????? ?????????????? ???? ????????????</div>
                                </div>
                                ...
                                <div class="achievement-badge locked" data-achievement="review-master">
                                    <div class="badge-icon">????</div>
                                    <div class="badge-name">???????? ????????????????</div>
                                    <div class="badge-description">???????????? 50 ???????? ??????????</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="category-progress-section">
                        <h3 class="category-progress-title">???????? ????????????</h3>
                    ...
                    <div class="analytics-dashboard">
                        ...
                        <div class="analytics-section">
                            <div class="analytics-card">
                                ...
                                <p class="analytics-card-subtitle">???????????????? ???????????? ???????????????? ????????????</p>
            ...
            class SideMenuFilters {
                constructor() {
                    ...
                    this.proficiencyLevels = [
                        { id: 'A1', name: 'A1 - ??????????', description: '?????????????? ?????????????? ??????????????????', wordCount: 590, icon: '????' },
                        { id: 'A2', name: 'A2 - ???? ?????? ??????????????', description: '?????????????? ?????????????? ??????????????', wordCount: 710, icon: '????' },
                        { id: 'B1', name: 'B1 - ??????????', description: '?????????????? ??????????????', wordCount: 468, icon: '????' },
                        { id: 'B2', name: 'B2 - ?????? ??????????????', description: '?????????????? ?????????????? ??????????????', wordCount: 372, icon: '????' },
                        { id: 'C1', name: 'C1 - ??????????', description: '?????????????? ??????????????', wordCount: 102, icon: '????' },
                        { id: 'C2', name: 'C2 - ??????????', description: '?????????? ?????????????? ????????????????', wordCount: 10, icon: '????' }
                    ];
                    
                    this.learningModes = [
                        { id: 'flashcard', name: '???????????????? ??????????????????', description: '???????? ?????????????? ???????????????? ???????????????? ??????????????????', icon: '????' },
                        { id: 'quiz', name: '???????????????????? ??????????????????', description: '?????????? ???????????? ???????????????? ??????????????', icon: '????' },
                        { id: 'phrase', name: '???????????????? ??????????????????', description: '???????? ???????????????? ?????????????? ?????????????? ????????????????', icon: '????' },
                        { id: 'conversation', name: '?????????????????? ??????????????????', description: '???????? ?????? ?????????????????? ?????????????? ????????????????', icon: '????' },
                        { id: 'review', name: '???????????????? ??????????????????', description: '???????? ?????????????? ?????????? ?????????????? ???????????????? ??????????', icon: '????' }
                    ];
                ...
                getCategoryIcon(categoryId) {
                    const icons = {
                        ...
                        'emotion': '????', 'family': '?????????????????????????', 'food': '???????', 'greeting': '????', 'health': '????', 'house': '????',
                        'job': '????', 'nature': '????', 'number': '????', 'place': '????', 'pronoun': '????', 'question': '???',
                        'sport': '???', 'time': '???', 'transport': '????', 'verb': '???', 'weather': '???????'
                    };
                ...
                createSideMenu() {
                    ...
                    sideMenu.innerHTML = \`
                        <div class="side-menu-header">
                            <h3 class="side-menu-title"><i class="fas fa-sliders-h"></i> ?????????????? ????????????</h3>
                            <p class="side-menu-subtitle">???????? ?????????? ?????????????? ???????? ???????????? ???????????? ????????</p>
                            <button class="side-menu-close" onclick="window.sideMenuFilters.closeMenu()"><i class="fas fa-times"></i></button>
                        </div>
                        
                        <!-- Filter Type Selection -->
                        <div class="filter-section">
                            <h4 class="filter-section-title"><i class="fas fa-filter icon"></i> ?????????? ??????????????</h4>
                        ...
                        <div class="filter-section">
                            <h4 class="filter-section-title"><i class="fas fa-gamepad icon"></i> ?????? ????????????</h4>
                    ...
                    return this.categories.map(category => \`
                        <div class="category-item" data-category="\${category.id}" onclick="window.sideMenuFilters.handleCategorySelection('\${category.id}')" style="display: flex; align-items: center; padding: 0.75rem; border-bottom: 1px solid #f1f5f9; cursor: pointer; transition: background-color 0.2s;">
                            ...
                            <div style="flex: 1;">
                                ...
                                <div style="font-size: 0.75rem; color: #64748b;">\${category.wordCount} ???????? ??? \${category.sessionCount} ????????</div>
                            </div>
                        </div>
                    \`).join('');
                }
                ...
                renderFilterContent() {
                    if (this.filterType === 'categories') {
                        return \`
                            <div class="filter-section">
                                <h4 class="filter-section-title"><i class="fas fa-folder-open icon"></i> ????????????</h4>
                        ...
                        return \`
                            <div class="filter-section">
                                <h4 class="filter-section-title"><i class="fas fa-graduation-cap icon"></i> ?????????????? ??????????????</h4>
                                <p style="font-size: 0.75rem; color: #64748b; margin-bottom: 1rem; padding: 0.5rem; background: #f0f9ff; border-radius: 0.5rem; border-left: 3px solid #0ea5e9;">
                                    <i class="fas fa-info-circle" style="margin-left: 0.25rem;"></i> ???????? ?????????? ?????????????? ?????????? ???????????? ???????????????? CEFR
                                </p>
                    ...
                    return this.proficiencyLevels.map(level => \`
                        <div class="proficiency-item" data-level="\${level.id}" onclick="window.sideMenuFilters.handleProficiencySelection('\${level.id}')" style="display: flex; align-items: center; padding: 0.75rem; border-bottom: 1px solid #f1f5f9; cursor: pointer; transition: background-color 0.2s;">
                            ...
                            <div style="flex: 1;">
                                ...
                                <div style="font-size: 0.75rem; color: #64748b;">\${level.description} ??? \${level.wordCount} ????????</div>
                            </div>
                        </div>
                    \`).join('');
                }
                        ...
                        setTimeout(() => {
                            ...
                            if (window.vocabularySessions && window.vocabularySessions.createSessionsFromWords && learningData.words) {
                                try {
                                    ...
                                    console.warn('?????? Session manager error, using full word set:', error);
                                }
                            }
            ...
            class HomepageEnhancements {
                ...
                setupDemoFeatures() {
                    ...
                    window.playDemoSound = () => {
                        const demoWords = ['??????????', '????????????', 'Merhaba', 'Te??ekk??rler'];
                        const randomWord = demoWords[Math.floor(Math.random() * demoWords.length)];
                        
                        // Create a notification
                        this.showNotification('???? ?????????? ??????: ' + randomWord, 'success');
                ...
                window.updateAuthStatus = function() {
                    ...
                    if (isAuthenticated) {
                        ...
                        if (user.isGoogleUser && user.picture) {
                            ...
                            if (userLoginType) {
                                userLoginType.textContent = '???? ?????????? ???????????? ?????? Google';
                        ...
                        if (user.stats) {
                            ...
                            updateElement('total-time', (stats.totalTime || 0) + '??');
